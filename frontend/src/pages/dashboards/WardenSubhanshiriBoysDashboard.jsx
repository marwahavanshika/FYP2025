...
const WardenSubhanshiriBoysDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">Subhanshiri Boys Hostel Dashboard</h1>
...
export default WardenSubhanshiriBoysDashboard; 