...
const ElectricianDashboard = () => {
  ...
  // Fetch electrical-related complaints
  useEffect(() => {
    const fetchComplaints = async () => {
      setLoading(true);
      try {
        // The API should filter by category=electrical automatically for electricians
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">Electrician Dashboard</h1>
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-xl font-semibold mb-4">Electrical Complaints</h2>
        
        {complaints.length === 0 ? (
          <p className="text-gray-500">No electrical complaints found.</p>
        ) : (
      ...
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <div className="space-y-4 text-gray-700">
          ...
          <div>
            ...
            <ul className="list-disc pl-6 mt-2">
              <li><span className="font-medium text-red-600">High Priority</span>: Address immediately. These issues typically involve power outages, exposed wiring, or safety hazards.</li>
              <li><span className="font-medium text-yellow-600">Medium Priority</span>: Address within 24 hours. These issues may involve faulty electrical appliances or partial outages.</li>
              <li><span className="font-medium text-green-600">Low Priority</span>: Address when possible. These are usually minor issues like replacing light bulbs or fixing minor fixtures.</li>
            </ul>
          </div>
          
          <div>
            <h3 className="font-medium text-lg">Contact Information:</h3>
            <p className="mt-2">For electrical supply requests or additional help, contact the maintenance supervisor at ext. 4567.</p>
          </div>
        </div>
      </div>
    </div>
