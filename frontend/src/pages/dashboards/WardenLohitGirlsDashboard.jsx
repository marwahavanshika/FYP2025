...
const WardenLohitGirlsDashboard = () => {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">Lohit Girls Hostel Dashboard</h1>
...
export default WardenLohitGirlsDashboard; 