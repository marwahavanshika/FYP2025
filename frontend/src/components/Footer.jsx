...
const Footer = () => {
  ...
  return (
    <motion.footer 
      className="bg-gradient-to-r from-gray-50 to-gray-100 py-8 border-t border-gray-200"
      initial="hidden"
      whileInView="visible"
      viewport={{ once: true }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center">
              ...
              <span className="font-bold text-xl text-gray-800">Hostel Manager</span>
            </div>
            <p className="mt-2 text-gray-600 max-w-md">
              A comprehensive hostel management system designed to streamline operations, 
              enhance student experience, and provide efficient administrative tools.
            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="mt-4 space-y-2">
              {[
                ...
                { name: 'Mess Feedback', path: '/mess-feedback' },
              ].map((item) => (
                <li key={item.name}>
